...
const pageConfig: PageConfig = {
  ...
  title: "Rimrose's Status Page",
  // Links shown at the header of your status page, could set `highlight` to `true`
  links: [
    { link: 'https://github.com/SirTamago', label: 'GitHub' },
    { link: 'https://rimrose.work/', label: 'Blog' },
    { link: 'mailto:me@rimrose.work', label: 'Email Me', highlight: true },
  ],
